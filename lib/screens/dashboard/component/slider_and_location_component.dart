...
class _SliderLocationComponentState extends State<SliderLocationComponent> {
  ...
  void initState() {
    ...
    _timer = Timer.periodic(Duration(seconds: 5), (Timer timer) {
      if (_currentPage < widget.sliderList.length) {
        _currentPage++;
      } else {
        _currentPage = 0;
      }
      ...
      child: Stack(
        children: [
          widget.sliderList.isNotEmpty
              ? PageView(
                  ...
                  children: List.generate(
                    ...
                    (index) {
                      ...
                      return cachedImage(data.sliderImage, height: 250, width: context.width(), fit: BoxFit.cover).onTap(() {
              ...
              : cachedImage('', height: 250, width: context.width()),
