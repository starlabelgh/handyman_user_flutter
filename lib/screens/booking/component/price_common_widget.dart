              ...
              children: [
                Row(
                  children: [
                    ...
                    16.width,
                    PriceWidget(price: serviceDetail.price.validate(), size: 18, color: textPrimaryColorGlobal, isBoldText: true),
                  ],
                ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${appStore.currencySymbol}${serviceDetail.price.validate().toStringAsFixed(DECIMAL_POINT)} * ${bookingDetail.quantity}  = ${appStore.currencySymbol}${(serviceDetail.price.validate() * bookingDetail.quantity.validate()).toStringAsFixed(DECIMAL_POINT)}',
