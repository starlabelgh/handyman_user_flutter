...
class LanguageVi extends BaseLanguage {
  ...
  @override
  String get alreadyHaveAccountTxt => "Bạn co săn san để tạo một tai khoản?";

  @override
  String get rememberMe => "Nhớ tôi";

  @override
  String get forgotPasswordTitleTxt => "Nhập email để đặt lại \ n mật khẩu của bạn";
  ...
  @override
  String get afterLogoutTxt => "Bạn có muốn đăng xuất khỏi ứng dụng? Bạn luôn có thể đăng nhập lại!";
  ...
  @override
  String get lblCheckInternet => "Hãy chắc chắn rằng bạn được kết nối với internet";
  ...
  @override
  String get walkThrough3 => "Chọn tùy chọn thanh toán thích hợp hơn và nhận dịch vụ tốt nhất.";
  ...
  @override
  String get lblUnAuthorized => "Người dùng demo không thể được cấp cho hành động này";
  ...
  @override
  String get msgForLocationOn => "Vị trí đang bật. Người dùng chỉ có thể duyệt chỉ những dịch vụ có sẵn ở vị trí hiện tại của bạn";

  @override
  String get msgForLocationOff => "Vị trí là off.userer có thể duyệt tất cả các dịch vụ";
  ...
  @override
  String get lblChangePwdTitle => "Mật khẩu mới của bạn phải khác với mật khẩu đã sử dụng trước đó";

  @override
  String get lblForgotPwdSubtitle => " Một liên kết mật khẩu thiết lập lại sẽ được gửi đến địa chỉ email đã nhập ở trên";

  @override
  String get lblLoginTitle => "Xin chào lần nữa ";

  @override
  String get lblLoginSubTitle => " Chào mừng trở lại, bạn đã bị bỏ lỡ trong thời gian dài";
  ...
  @override
  String get lblConfirmReviewSubTitle => " Bạn có chắc chắn muốn xóa đánh giá này?";

  @override
  String get lblConfirmService => "Bạn có chắc chắn muốn giữ dịch vụ này?";

  @override
  String get lblConFirmResumeService => "Bạn có chắc chắn muốn tiếp tục dịch vụ này?";
  ...
  @override
  String get lblIntroducingCustomerRating => " Giới thiệu đánh giá của khách hàng";
  ...
  @override
  String get lblWalkThroughSubTitle => "Dịch vụ Handyman - Ứng dụng dịch vụ gia đình theo yêu cầu với giải pháp hoàn chỉnh";
  ...
  @override
  String get lblLocationOffMsg => "Vị trí bị tắt. Khám phá và tìm các dịch vụ có sẵn cho khu vực đã chọn của bạn.";
  ...
  @override
  String get lblNotAvailableNumber => "Không có số đường dây trợ giúp không có sẵn";
  ...
  @override
  String get lblWalkThrough0 => "Dịch vụ Handyman - Ứng dụng dịch vụ gia đình theo yêu cầu với giải pháp hoàn chỉnh";
  ...
  @override
  String get lblAndroid12Support => "Hành động này sẽ khởi động lại ứng dụng của bạn. Xác nhận?";
  ...
  @override
  String get lblOnlyUserCanLoggedInHere => "Chỉ người dùng mới có thể đăng nhập ở đây";
